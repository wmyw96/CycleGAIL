...
'''
python run_joint_synthetic.py --name logs/cjsyn-wgan-gp-128 --lr 0.0001 --clip 0.01 --nhid 128 --loss_metric L2 --epoch 100000 --ntraj 100 --gamma 1.0 --lg 1.0 --lf 1.0 --loss wgan-gp
'''