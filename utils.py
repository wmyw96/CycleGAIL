...
def distribution_diff(state0, action0, state1, action1, state2, action2,
    ...
    ax2.scatter(state0[:, 0], action0[:, 1], color='b', s=0.5)
    ax2.scatter(state1[:, 0], action1[:, 1], color='r', s=0.5)
    ax2.scatter(state2[:, 0], action2[:, 1], color='y', s=0.5)
    ax3 = figure.add_subplot(333)
    ax3.scatter(state0[:, 0], action0[:, 2], color='b', s=0.5)
    ax3.scatter(state1[:, 0], action1[:, 2], color='r', s=0.5)
    ax3.scatter(state2[:, 0], action2[:, 2], color='y', s=0.5)
    ...
    ax5.scatter(state0[:, 1], action0[:, 1], color='b', s=0.5)
    ax5.scatter(state1[:, 1], action1[:, 1], color='r', s=0.5)
    ax5.scatter(state2[:, 1], action2[:, 1], color='y', s=0.5)
    ax6 = figure.add_subplot(336)
    ax6.scatter(state0[:, 1], action0[:, 2], color='b', s=0.5)
    ax6.scatter(state1[:, 1], action1[:, 2], color='r', s=0.5)
    ax6.scatter(state2[:, 1], action2[:, 2], color='y', s=0.5)
    ax7 = figure.add_subplot(337)
    ax7.scatter(state0[:, 2], action0[:, 0], color='b', s=0.5)
    ax7.scatter(state1[:, 2], action1[:, 0], color='r', s=0.5)
    ax7.scatter(state2[:, 2], action2[:, 0], color='y', s=0.5)
    ax8 = figure.add_subplot(338)
    ax8.scatter(state0[:, 2], action0[:, 1], color='b', s=0.5)
    ax8.scatter(state1[:, 2], action1[:, 1], color='r', s=0.5)
    ax8.scatter(state2[:, 2], action2[:, 1], color='y', s=0.5)
    ax9 = figure.add_subplot(339)
    ax9.scatter(state0[:, 2], action0[:, 2], color='b', s=0.5)
    ax9.scatter(state1[:, 2], action1[:, 2], color='r', s=0.5)
    ax9.scatter(state2[:, 2], action2[:, 2], color='y', s=0.5)
    if filename is not None:
        plt.savefig(filename)
        plt.close()
    else:
